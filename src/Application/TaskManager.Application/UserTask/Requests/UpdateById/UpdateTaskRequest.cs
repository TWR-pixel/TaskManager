...
public sealed record UpdateTaskRequest(int UpdatingTaskId,
                                       ...
                                       bool? IsInProgress = null) : RequestBase<UpdateUserTaskResponse>;
...
public sealed class UpdateTaskRequestHandler(IUnitOfWork unitOfWork)
        : RequestHandlerBase<UpdateTaskRequest, UpdateUserTaskResponse>(unitOfWork)
{
    public override async Task<UpdateUserTaskResponse> Handle(UpdateTaskRequest request, CancellationToken cancellationToken)
    {
